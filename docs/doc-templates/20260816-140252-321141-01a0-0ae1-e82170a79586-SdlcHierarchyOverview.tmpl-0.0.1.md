...
---
doc-id:      20260816-140252-321141-01a0-0ae1-e82170a79586-SdlcHierarchyOverview
version:      0.0.1
status:       ACTIVE
category:     REFERENCE
description: >
...
flowchart TD
    ...
    subgraph "Layer 1 — Engine + Spark"
        BD["⚙️ EcommTransitFatigue.driv<br/><b>THE PROBLEM</b><br/>Pickers walk 12+ miles/day<br/>$2B annual transit fatigue cost"]:::driv
        BM["🔥 IndoorDroneFleet.moti<br/><b>THE SOLUTION</b><br/>Deploy indoor drone fleet<br/>to eliminate picker transit"]:::moti
    end

    subgraph "Layer 2 — Action"
        F300["🚗 AutonomousNavigation.feat<br/><b>Autonomous Indoor Navigation</b><br/>Drones navigate warehouse aisles<br/>without human control"]:::feat
        F300A["🚗 BatteryHotSwap.feat<br/><b>Automated Battery Hot-Swap</b><br/>Robotic arm swaps batteries<br/>without landing"]:::feat
    end

    subgraph "Layer 3 — Blueprint + Measurement"
        A500["🏗️ SpatialVisionGuidance.arch<br/><b>Spatial Vision Guidance System</b><br/>Component decomposition for<br/>obstacle avoidance"]:::arch
        SP400["📐 PayloadCapacity.spec<br/><b>Payload Carrying Capacity</b>"]:::spec
    end

    subgraph "Layer 4 — Proof"
        SP400A["📐 MaxLiftoffMass.spec<br/><b>Max Liftoff Mass</b>"]:::spec
        LEAF["🛑 25.0 kg"]:::leaf
    end
