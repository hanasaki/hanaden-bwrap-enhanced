...
<!--
╔══════════════════════════════════════════════════════════════════════════════╗
║  HANADEN ENTERPRISE BUG REPORT TEMPLATE — TMPL-BUG-REPORT v0.0.1           ║
║  (c) 2026 Hanaden.AI — All rights reserved                                  ║
║                                                                              ║
║  HOW TO USE THIS TEMPLATE                                                    ║
║  1. Copy this file to docs/development-ongoing/bugs/                         ║
║  2. Rename using the Hanaden Hybrid ID convention:                           ║
║     YYYYMMDD-HHMMSS-uuuuuu-7xxx-Nxxx-xxxxxxxxxxxx-short-description.md     ║
║     Generate: date -u +"%Y%m%d-%H%M%S" + microseconds + UUIDv7 suffix       ║
║  3. Declare your tier at the top: LEAN | FULL | SEC                          ║
║  4. Delete sections marked <!-- TIER:LEAN-SKIP --> if you are Lean tier     ║
║  5. Delete sections marked <!-- TIER:SEC-ONLY --> if not a security bug      ║
║  6. Replace all <PLACEHOLDER> tokens with real values                        ║
║  7. Delete this comment block before committing                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
-->

---
<!-- BUG FRONTMATTER — MUST be present in all tiers -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 0: METADATA SNAPSHOT  [ALL TIERS — MUST]
     A quick-scan table for triage and dashboard views.
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 1: TIER DECLARATION  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 2: SEVERITY MATRIX  [ALL TIERS — MUST]
     All criteria are QUANTITATIVE. No subjective language permitted.
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 3: REPORTER IDENTITY  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 4: DESCRIPTION  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 5: REPRODUCIBILITY  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 7: EVIDENCE  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 8: IMPACT ANALYSIS  [MUST — FULL, SEC | SHOULD — LEAN]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 9: ROOT CAUSE ANALYSIS  [SHOULD — LEAN | MUST — FULL, SEC]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 10: PROPOSED FIX OPTIONS  [MAY — LEAN | SHOULD — FULL, SEC]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 11: ACCEPTANCE CRITERIA  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 12: TRACEABILITY  [MUST — FULL, SEC | SHOULD — LEAN]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 13: SECURITY CLASSIFICATION  [MUST — SEC | SHOULD — FULL | MAY — LEAN]
     ═══════════════════════════════════════════════════════════════════════════ -->
<!-- TIER:SEC-ONLY (delete this entire section for LEAN/FULL non-security bugs) -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 14: DISCLOSURE / TLP  [MUST — SEC | NOT APPLICABLE — LEAN, FULL non-security]
     ═══════════════════════════════════════════════════════════════════════════ -->
<!-- TIER:SEC-ONLY -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 15: ESCALATION PATHS  [SHOULD — FULL | MUST for HIGH+ — SEC]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 16: CLOSE RECORD  [ALL TIERS — MUST before closing]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 17: REFERENCES  [ALL TIERS — MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
