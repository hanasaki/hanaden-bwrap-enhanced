...
Specifications are:
- **Recursive** — a SPEC may contain sub-SPECs (SPEC-NNN → SPEC-NNN-SubA → SPEC-NNN-SubB).
...
flowchart TD
    ...
    SP["📐 SPEC-PERF-400<br/>Payload Carrying Capacity<br/><i>layer: 3</i>"]:::spec

    SPA["📐 SPEC-PERF-400-SubA<br/>Maximum Liftoff Mass Limit<br/><i>layer: 4</i>"]:::sub
    SPB["📐 SPEC-PERF-400-SubB<br/>Structural Frame Deflection<br/><i>layer: 4</i>"]:::sub
...
flowchart LR
    ...
    SP["📐 SPEC-HW-600<br/>Optical LiDAR Array<br/><i>layer: 3</i>"]:::spec

    SPA["📐 SPEC-HW-600-SubA<br/>Laser Emitter Pulse Freq<br/><i>layer: 4</i>"]:::sub
    LV["🛑 Leaf: <b>150 kHz</b>"]:::leaf

    FEAT["🚗 FEAT-301<br/>Blind-Spot Night-Vision Nav<br/><i>unlocked by SubA</i>"]:::unlock
