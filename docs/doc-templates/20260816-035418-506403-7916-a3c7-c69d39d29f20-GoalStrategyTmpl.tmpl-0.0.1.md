...
> for human-readable reference (e.g. "CorpStrategy2026").
...
|----|-------------|--------|---------------|
| F-01 | [test description] | [how to run] | [pass condition] |
...
| 0.0.2 | 2026-08-16 | Frederick Bloom | Schema refactor: drop `node-id`, drop `children`, all pointers use `filename-id`, add definition block |
