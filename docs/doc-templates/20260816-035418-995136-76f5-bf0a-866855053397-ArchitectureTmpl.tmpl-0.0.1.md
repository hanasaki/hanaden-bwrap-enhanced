...
---
doc-id:      20260816-035418-995136-76f5-bf0a-866855053397-ArchitectureTmpl
version:      0.0.1
status:       ACTIVE
category:     TEMPLATE
...
> [!NOTE]
> **Directory convention:** Architecture documents live in `Slug.arch/` directories.
> An ARCH may be a **sibling** of Features under a Motivator when it describes
> cross-cutting structure spanning all features. No UUIDv7 on directory names.
...
> **Test file:** `src/test/{project}/.../Slug.arch/test_slug.sh`
...
| 0.0.1 | 2026-08-16 | Frederick Bloom | Schema refactor: drop `node-id`/`children`, all pointers use `filename-id`, add definition block |
| 0.0.1 | 2026-08-16 | Frederick Bloom + AI | Add tdd: frontmatter, TDD column, test-file ref, cross-cutting arch note, dir convention |
