...
<!--
╔══════════════════════════════════════════════════════════════════════════════╗
║  HANADEN ENTERPRISE INCIDENT REPORT TEMPLATE — TMPL-INCIDENT-REPORT v0.0.1 ║
║  (c) 2026 Hanaden.AI — All rights reserved                                  ║
║                                                                              ║
║  WHEN TO USE THIS TEMPLATE                                                   ║
║  An incident report is DISTINCT from a bug report. File this when:          ║
║  - Data loss, corruption, or integrity failure occurred                      ║
║  - A production or staging outage affected real users                        ║
║  - A systemic AI-caused failure is identified                                ║
║  - A process breakdown caused cascading failures                             ║
║  - A CRITICAL or HIGH bug requires a full post-mortem narrative              ║
║                                                                              ║
║  DRY PRINCIPLE                                                               ║
║  Incidents MAY spawn one or more bug reports (TMPL-BUG-REPORT).             ║
║  Bug reports are REFERENCED here — their content is NOT duplicated.         ║
║                                                                              ║
║  HOW TO FILE                                                                 ║
║  1. Copy to docs/incident-reports/                                           ║
║  2. Rename: YYYYMMDD-HHMMSS-uuuuuu-7xxx-Nxxx-xxxxxxxxxxxx-description.md   ║
║  3. Update README.md index in docs/incident-reports/                         ║
║  4. Update status in frontmatter as investigation progresses                 ║
║  5. Delete this comment block before committing                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
-->

---
<!-- INCIDENT FRONTMATTER — MUST be present -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 0: INCIDENT SNAPSHOT  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 1: SEVERITY CLASSIFICATION  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 2: EXECUTIVE SUMMARY  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 3: ENVIRONMENT  [MUST for CRITICAL/HIGH | SHOULD for MEDIUM]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 5: ROOT CAUSE ANALYSIS  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
### 5.5 Root Cause Chain Diagram [SHOULD]
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 6: BLAST ZONE / IMPACT  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 7: DEFECTS INVENTORY  [MUST if bugs were spawned]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 8: EVIDENCE INVENTORY  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 9: CORRECTIVE ACTIONS  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 10: ESCALATION AND SUPPORT PATHS  [SHOULD — ALL | MUST — CRITICAL/HIGH]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 11: DISCLOSURE / TLP  [MUST — CRITICAL/HIGH with security impact]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 12: AI-SPECIFIC ANALYSIS  [MUST if AI-caused | NOT APPLICABLE otherwise]
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     SECTION 13: LIFECYCLE GOVERNANCE  [MUST]
     ═══════════════════════════════════════════════════════════════════════════ -->
