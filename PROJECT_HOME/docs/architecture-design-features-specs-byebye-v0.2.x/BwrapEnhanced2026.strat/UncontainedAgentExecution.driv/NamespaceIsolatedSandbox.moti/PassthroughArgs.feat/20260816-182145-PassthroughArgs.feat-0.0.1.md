...
graph TD
    ...
    F --> TE["TildeExpansion.spec<br/>~/path → $HOME/path"]
    F --> BP["BindPassthrough.spec<br/>9 bind flag types"]
    F --> SEP["SetenvPassthrough.spec<br/>--setenv/--unsetenv"]
    F --> LW["LastWinsSemantics.spec<br/>passthrough appended last"]
```
