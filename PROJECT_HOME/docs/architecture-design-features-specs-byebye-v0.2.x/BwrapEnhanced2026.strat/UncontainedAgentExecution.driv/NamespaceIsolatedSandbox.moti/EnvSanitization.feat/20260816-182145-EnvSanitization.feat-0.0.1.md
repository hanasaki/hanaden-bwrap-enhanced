...
graph TD
    ...
    F --> ES["EnvStrip.spec<br/>--clearenv prepended first"]
    F --> EIO["EnvInheritOverride.spec<br/>host vars inherited + overrides"]
    F --> XDG["XdgVarsSet.spec<br/>XDG_DATA_HOME XDG_STATE_HOME MOZ_NO_REMOTE"]
```
