...
OPS/
Assume any needed  tools and testing tools, including AI-programming-assistants, are avaialble for use within the sandbox environment either installed in the sandbox or via MISE.
* Testing Tooo Chains - Assume tools in filesustem, via MISE are avaialble for:
Unit, Integration, ProdSecurity, Pen-Testing
Chaos Engineering
